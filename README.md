...
| `image`                 | String | $IMAGE                            | The image to create a attestation for (Deprecated in favor for `image_digest`)                                                                          | False    |
| `image_digest`          | String | ""                                | The image digest to create a attestation for                                                                                                            | False    |
